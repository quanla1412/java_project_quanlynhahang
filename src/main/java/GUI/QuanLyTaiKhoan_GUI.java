...
public class QuanLyTaiKhoan_GUI extends javax.swing.JFrame {
    ...
    /**
     * Creates new form QuanLyTaiKhoan_GUI
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuanLyTaiKhoan_GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuanLyTaiKhoan_GUI().setVisible(true);
            }
        });
    }
